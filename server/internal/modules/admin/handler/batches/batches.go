...
func failErr(c *gin.Context, err error) {
	...
	case errors.Is(err, model.ErrNameTaken), errors.Is(err, model.ErrSystemNode):
	...
	case errors.Is(err, model.ErrInvalidDateRange), errors.Is(err, model.ErrEmptyImport):
...
func (h *Handler) AssignTutor(c *gin.Context) {
	...
	var req dto.AssignTutorRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		httpx.Fail(c, http.StatusBadRequest, err.Error())
		return
	}
